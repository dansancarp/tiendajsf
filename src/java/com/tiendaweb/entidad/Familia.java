...
@NamedQueries({
    ...
    , @NamedQuery(name = "Familia.findByAbreviatura", query = "SELECT f FROM Familia f WHERE f.abreviatura = :abreviatura")
    , @NamedQuery(name = "Familia.findByVersion", query = "SELECT f FROM Familia f WHERE f.version = :version")})
public class Familia implements Serializable {
    ...
    public String toString() {
        return "com.tiendaweb.entidad.Familia[ id=" + id + " ]";
    }
